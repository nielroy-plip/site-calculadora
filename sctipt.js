...
function calcular() {
    var resultado = document.getElementById('resultado1').innerHTML;
    if(resultado) {
        document.getElementById('resultado1').innerHTML = eval(resultado);
    }
    else{
        document.getElementById('resultado1').innerHTML = "Nada para calcular";
    }
}
...
let valorDoDolar   = 4.6175001       // 5.28
let valorDoEuro    = 5.0765003      // 6.20
let valorDaLibra   = 6.0567995     // 7.20
let valorDoBitcoin = 214570.54  // 224115,01 as 14:16 UTC ou 11:19
let valorEmReal    = 0
